...
export default function Game({ totalPalito, playersGuess, setPlayersGuess, ganhador, setGanhador, socket, players, setPlayers, setGameStart, playerNumber, setPlayerNumber, numberOfPlayers, setnumberOfPlayers, playerTurn, setPlayerTurn }) {
      ...
      <Grid container style={{ height: '70vh' }}>
        ...
        <Grid item xs={4}>
          ...
          {players[1].id ? <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
            <Typography color={ganhador === players[1].number ? 'green' : 'black'} variant="h5" gutterBottom>
        ...
        <Grid item xs={4}>
          ...
          {players[2].id ? <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
            ...
            <Typography color={ganhador === players[0].number ? 'green' : 'black'} variant="h5" gutterBottom>
        ...
        <Grid item xs={4}>
          ...
          {ganhador && <Box sx={{ textAlign: 'center' }}><Palito number={totalPalito} /></Box>}
        </Grid>
        <Grid item xs={4}>
          ...
          {players[3].id ? <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
            ...
            <Typography color={ganhador === players[3].number ? 'green' : 'black'} variant="h5" gutterBottom>
